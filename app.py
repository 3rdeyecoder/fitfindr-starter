...
def handle_query(user_query: str, wardrobe_choice: str) -> tuple[str, str, str]:
    ...
    listing_text = (
        f"{selected_item.get('title', 'Unknown item')} — ${selected_item.get('price', 'unknown')} on {selected_item.get('platform', 'unknown')}\n"
        f"Size: {selected_item.get('size', 'N/A')} | Condition: {selected_item.get('condition', 'N/A')}\n\n"
